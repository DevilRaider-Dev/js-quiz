...
data.forEach(obj => {
  ...
  div.setAttribute("style", "width:60vw; margin: auto");
  ...
  //create the button with click function
  obj.choice.forEach(choise => {
    let button = document.createElement("button");
    button.setAttribute("style", "width: 10vw; margin-bottom:5%");
    button.innerHTML= choise;
    button.addEventListener('click', () => {
      if(button.innerHTML == obj.answer){
        button.setAttribute("style", "width: 10vw; margin-bottom:5%; background:green");
      }else{
        button.setAttribute("style", "width: 10vw; margin-bottom:5%; background:red");
      }
    });
  ...
  //add button to the div with the id: content
